...
def main(args):
    ...
    parser.add_argument("--deployto", default=os.name)
    ...
    env = Environment(loader=FileSystemLoader(os.path.join(BASEDIR, "templates"), encoding="utf-8"))
    ...
    for path, file in locate("*.md", args.input):
        ...
        open(os.path.join(distpath, file[:-2]+"html"), "w", encoding="utf-8").write(html)
    return 0
